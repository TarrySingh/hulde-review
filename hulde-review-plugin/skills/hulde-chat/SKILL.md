---
name: hulde-chat
description: Use when you need to ask questions about a codebase or understand code using a knowledge graph for code review
argument-hint: [query]
---

# /hulde-chat

Answer questions about this codebase using the knowledge graph at `.hulde-review/knowledge-graph.json`.
...
1. Check that `.hulde-review/knowledge-graph.json` exists in the current project root. If not, tell the user to run `/hulde-review` first.
