  ...
  return (
    <div className="h-full w-full flex flex-col bg-surface overflow-hidden">
      ...
      <div className="flex-1 overflow-auto p-5">
        {/* Summary */}
        <div className="mb-4">
          <h4 className="text-[11px] font-semibold text-hulde-green uppercase tracking-wider mb-2">Summary</h4>
          <p className="text-sm text-text-secondary leading-relaxed">{node.summary}</p>
        </div>

        {/* Language notes callout */}
        {node.languageNotes && (
          <div className="mb-4 bg-hulde-green/5 border border-hulde-green/20 rounded-lg p-3">
            <h4 className="text-[11px] font-semibold text-hulde-green uppercase tracking-wider mb-1.5">Language Notes</h4>
        ...
        {node.tags.length > 0 && (
          <div className="mb-4">
            <h4 className="text-[11px] font-semibold text-hulde-green uppercase tracking-wider mb-2">Tags</h4>
