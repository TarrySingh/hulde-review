...
const complexityBadgeColors: Record<string, string> = {
  ...
  moderate: "text-hulde-green-dark border border-hulde-green-dark/30 bg-hulde-green-dark/10",
      ...
      {node.languageNotes && (
        <div className="mb-4">
          <button
            ...
            className="flex items-center gap-1.5 text-xs font-semibold text-hulde-green uppercase tracking-wider mb-2 hover:text-hulde-green-bright transition-colors"
          >
            <svg
          ...
          {languageExpanded && (
            <div className="bg-hulde-green/5 border border-hulde-green/20 rounded-lg p-3">
          ...
          <div className="space-y-1.5">
            {connections.map((edge, i) => {
              ...
              return (
                ...
                >
                  <span className="text-hulde-green font-mono">{arrow}</span>
