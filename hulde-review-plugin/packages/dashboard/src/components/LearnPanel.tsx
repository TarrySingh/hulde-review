  ...
  if (!tourActive) {
    return (
      <div className="h-full w-full overflow-auto p-5">
        ...
        <button
          onClick={startTour}
          className="w-full mb-4 bg-hulde-green/10 border border-hulde-green/30 text-hulde-green text-sm font-medium py-2.5 px-4 rounded-lg hover:bg-hulde-green/20 transition-colors"
        >
          Start Tour
        </button>
        ...
        <div className="space-y-2">
          ...
          {tourSteps.map((step, i) => (
            ...
            >
              <span className="text-hulde-green font-mono shrink-0 mt-0.5">
                {i + 1}.
              </span>
    ...
    <div className="h-full w-full flex flex-col overflow-hidden">
      ...
      <div className="flex items-center justify-between px-3 py-2 border-b border-border-subtle shrink-0">
        <div className="flex items-center gap-2">
          <h3 className="text-[11px] font-semibold text-hulde-green uppercase tracking-wider">
            Tour
          </h3>
      ...
      <div className="h-1 bg-elevated shrink-0">
        <div
          className="h-full bg-hulde-green transition-all duration-300"
      ...
      <div className="flex-1 overflow-y-auto p-4 min-h-0">
        ...
        {/* Language lesson */}
        {step.languageLesson && (
          <div className="bg-hulde-green/5 border border-hulde-green/20 rounded p-3 mb-4">
            <h4 className="text-[11px] font-semibold text-hulde-green uppercase tracking-wider mb-1.5">
              Language Lesson
            </h4>
        ...
        {step.nodeIds.length > 0 && (
          <div className="mb-4">
            <h4 className="text-[11px] font-semibold text-hulde-green uppercase tracking-wider mb-2">
      ...
      <div className="px-3 py-2 border-t border-border-subtle shrink-0">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className="flex-1 text-xs bg-hulde-green/10 border border-hulde-green/30 text-hulde-green py-1.5 rounded-lg hover:bg-hulde-green/20 transition-colors"
          >
            {isLast ? "Finish" : "Next"}
          </button>
        </div>
